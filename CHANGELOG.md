...
- Add a snap content interface plug for read-only configuration snaps and document `env-file-path` provisioning through a provider snap, [Issue-1612](https://github.com/reductstore/reductstore/issues/1612), [PR-1613](https://github.com/reductstore/reductstore/pull/1613)
