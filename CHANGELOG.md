...
- Support hierarchical entry paths and preserve nested tree recovery with globally ordered multi-entry reads, [PR-1185](https://github.com/reductstore/reductstore/pull/1185)
