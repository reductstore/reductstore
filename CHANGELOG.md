...
- Remove deprecated `each_n` query and replication API field; use the `$each_n` operator in the `when` condition instead, [Issue-1359](https://github.com/reductstore/reductstore/issues/1359)
