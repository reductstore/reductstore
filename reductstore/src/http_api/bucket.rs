...
use crate::http_api::bucket::create::create_bucket;
use crate::http_api::bucket::get::get_bucket;
use crate::http_api::bucket::head::head_bucket;
use crate::http_api::bucket::remove::remove_bucket;
use crate::http_api::bucket::rename::rename_bucket;
use crate::http_api::bucket::update::update_bucket;
