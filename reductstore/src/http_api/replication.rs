...
use crate::http_api::replication::create::create_replication;
use crate::http_api::replication::get::get_replication;
use crate::http_api::replication::list::list_replications;
use crate::http_api::replication::remove::remove_replication;
use crate::http_api::replication::set_mode::set_mode;
use crate::http_api::replication::update::update_replication;
use axum::body::Body;
    ...
    S: Send + Sync,
{
    ...
    async fn from_request(req: Request<Body>, state: &S) -> Result<Self, Self::Rejection> {
        ...
        let response = match serde_json::from_slice::<ReplicationModePayload>(&*bytes) {
            ...
            Err(e) => Err(crate::http_api::HttpError::from(e)),
        };
        response
    }
}
